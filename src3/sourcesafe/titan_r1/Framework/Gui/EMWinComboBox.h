...
#ifndef __EM_WIN_COMBO_BOX
#define __EM_WIN_COMBO_BOX
...
class EMWinComboBox : public EMComboBox
{
public:
	EMWinComboBox(const EMRect p_oFrame, uint32 p_vMessage, uint32 p_vResizingMode, bool p_vAutoSort);
	~EMWinComboBox();
	...
	void ExecuteCommand();
	int FindString(const char* p_vpString);
	EMRect Frame() const;
