...
const	TSonorkLangCodeRecord	*
 TSonorkLangCodeTable::GetRecordByIndex(int index)
{
	if(IsLoaded())
...
const	TSonorkLangCodeRecord	*
 TSonorkLangCodeTable::GetRecordByCode(DWORD code, int *p_index)
{
	int i;
...
SONORK_RESULT
 TSonorkLangCodeTable::Load(TSonorkError& ERR, SONORK_C_CSTR file_name)
{
	FILE *F;
...
void
 TSonorkLanguageTable::Translate(TSonorkError& ERR)
{
...
SONORK_RESULT	TSonorkLanguageTable::Load(
		TSonorkError& 	ERR
