...
DWORD	TSonorkRemindData::CODEC_DataSize(DWORD ) const
{
	return
		sizeof(header)
		+	sizeof(DWORD)
		+	title.CODEC_Size(SONORK_NULL_CODEC_VERSION)
		+	notes.CODEC_Size(SONORK_NULL_CODEC_VERSION)
		+	values.CODEC_Size(SONORK_NULL_CODEC_VERSION);
}
...
DWORD
 TSonorkTaskData::CODEC_DataSize(DWORD ) const
{
