...
m_opPopupMenu(EM_new EMWinPopUpMenu()),
...
//	ShowWindow(m_opWindowHandle, SW_SHOW);
	...
	m_opMenuItem = EM_new EMWinMenuItem(&string("Large Icon"), CHANGE_LIST_VIEW_CONTROL_STYLE_TO_ICON);
	...
	m_opMenuItem = EM_new EMWinMenuItem(&string("Small Icon"), CHANGE_LIST_VIEW_CONTROL_STYLE_TO_SMALL_ICON);
	m_opPopupMenu -> AddItem(m_opMenuItem);
	//m_opMenuItem = EMFactory::Instance() -> CreateMenuItem(&string("List"), CHANGE_LIST_VIEW_CONTROL_STYLE_TO_LIST);
	m_opMenuItem = EM_new EMWinMenuItem(&string("List"), CHANGE_LIST_VIEW_CONTROL_STYLE_TO_LIST);
	m_opPopupMenu -> AddItem(m_opMenuItem);
}
