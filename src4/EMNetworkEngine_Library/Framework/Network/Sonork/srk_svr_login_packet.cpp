...
DWORD
 TSonorkSvrLoginReqPacket::CODEC_DataSize(DWORD ) const
{
	return  sizeof(DWORD)
		+	sizeof(header)
		+	password.CODEC_Size(SONORK_NULL_CODEC_VERSION)
		+	cryptInfo.CODEC_Size(SONORK_NULL_CODEC_VERSION)
		+	extData.CODEC_Size(SONORK_NULL_CODEC_VERSION);
}
...
DWORD TSonorkSvrLoginAknPacket::CODEC_DataSize(DWORD ) const
{
	return  sizeof(DWORD)
		+	sizeof(header)
		+	sid_info.CODEC_Size(SONORK_NULL_CODEC_VERSION)
		+	crypt_info.CODEC_Size(SONORK_NULL_CODEC_VERSION)
		+	ext_data.CODEC_Size(SONORK_NULL_CODEC_VERSION);
}
/*
