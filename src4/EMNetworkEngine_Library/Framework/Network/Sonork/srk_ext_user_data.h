...
struct  TSonorkExtUserCtrlData1
{
	TSonorkFlags		flags;
...
struct  TSonorkExtUserCtrlData2
:public TSonorkExtUserCtrlData1
{
	TSonorkTime		lastOnlineTime;
}__SONORK_PACKED;
...
public:
	...
	TSonorkExtUserCtrlData2 ctrlData;
	...
	TSonorkAuth2&
		Auth()
		{return ctrlData.auth;}

	TSonorkTime&
		LastOnlineTime()
		{ return ctrlData.lastOnlineTime; }

	DWORD
		GetVisualGroupNo() const
		{ return ctrlData.auth.GetGroupNo();}

	DWORD&
		AuthTag()
		{return ctrlData.auth.tag;}
	void
		ClearExtData();
