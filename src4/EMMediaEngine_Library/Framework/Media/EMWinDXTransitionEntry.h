...
#ifndef __EM_WIN_DX_TRANSITION_ENTRY
#define __EM_WIN_DX_TRANSITION_ENTRY
...
class EMWinDXTransitionEntry : public EMWinTransitionEntry
{
public:
	EMWinDXTransitionEntry(string p_oPluginName, IMoniker* p_opIMoniker, IDirectDraw7* p_opIDD, EMMediaType p_vType);
	virtual ~EMWinDXTransitionEntry();
