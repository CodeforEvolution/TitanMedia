...
* EM_TYPE_ANY, EM_TYPE_ANY_MIDI, etc. 
*
...
#ifndef __EM_WIN_MIDI_CLIP_REPOSITORY
#define __EM_WIN_MIDI_CLIP_REPOSITORY
...
class EMWinMIDIClipRepository : public EMMediaClipRepository, public EMListener
{
public:
	EMWinMIDIClipRepository();
	~EMWinMIDIClipRepository();
	int32 GetID() const;
...
private:
	...
	int32 m_vID;
//	EMMediaFormat* m_opSystemMIDIFormat;
};
